    ...
    if selected_report:
        ...
        with col3:
            ...
            <div style="text-align: center; padding: 10px;">
                <a href="http://10.1.223.229:8502" target="_blank" style="text-decoration: none;">
                    <button style="background-color: #007bff; color: white; padding: 8px 16px; border: none; border-radius: 4px; font-size: 13px; cursor: pointer;">
                        📊 Dashboard
                    </button>
                </a>
            </div>

...
# 🚀 Quick AWS Deployment Script for 5xx RCA System (Amazon Linux)
# This script automates the deployment process on AWS EC2 Amazon Linux

set -e  # Exit on any error

echo "🚀 Starting 5xx RCA System AWS Deployment (Amazon Linux)..."
echo "=========================================================="
...
sudo yum install -y python3 python3-pip git curl wget unzip gcc python3-devel
